/*
 HaxBall @ 2024 - NANOTA - All rights reserved.
 15ee796a
*/
'use strict';
(function (pa) {
    ...
    window.jimer = false
    window.jimer_ping = false
    window.jimer_opmode = false
    window.jimer_bubble = false
    ...
    class Sa {
        ...
        uc() {
            let a = ra.Cc
                , b = this.ic;
            this.jc != a && (null == b && (this.ic = b = new Sa),
                this.jc = a,
                Sa.zd(b, this));
            return b
        }
    ...
    class T {
        ...
        gs(a) {
            try {
                ...
                return window.crypto.subtle.sign(T.Lm, this.Zl, f).then(function (g) {
                    b.Yg(g);
                    return b.Wb()
                })
            } catch (b) {
        ...
        static cp() {
            try {
                return window.crypto.subtle.generateKey(T.vh, !0, ["sign", "verify"]).then(function (a) {
                    let b = a.privateKey;
        ...
        static Bs(a, b) {
            try {
                ...
                return T.Hs(g, h).then(function (n) {
    ...
    class kc {
        ...
        Yr(a) {
            a != this.Ck && (this.Kq.className = a ? "overtime on" : "overtime",
                this.Ck = a)
        }
        es(a) {
    ...
    class Ba {
        constructor(a) {
            ...
            k.onmousemove = function (t) {
                ...
                l.textContent = Ba.pl(a.Bf * a.sh * t);
        ...
        A() {
            this.os.textContent = Ba.pl(this.Gi.Ub);
            this.hr.style.width = 100 * this.Gi.lp() + "%";
            !this.lg || 0 < this.Gi.Qd || (this.lg = !1,
                this.Cq())
        }
        static pl(a) {
            a = a / 1E3 | 0;
    ...
    class Ta {
        constructor() {
            ...
            a.get("drag").onmousedown = function (c) {
                ...
                ;
            this.Fc = new Ob(a.get("autocompletebox"), function (c, d) {
                b.$a.value = c;
        ...
        hl(a) {
            ...
            b = this.Lc.scrollTop + b - this.Lc.scrollHeight >= .5 * -b || !Ta.Dp(this.Lc);
    ...
    class Z {
        constructor(a) {
            let b = new aa("Only humans", "", []);
            this.f = b.f;
            b.fe.style.minHeight = "78px";
            let c = this;
            kb.Np().then(function (d) {
                null == Z.Kg && (Z.Kg = window.document.createElement("div"),
                    b.fe.appendChild(Z.Kg),
                    Z.kr = d.render(Z.Kg, {
                        sitekey: a,
                        callback: function (e) {
                            D.h(Z.fm, e)
    ...
    class lb {
        ...
        hm() {
            let a = this;
            ba.Nk(m.Se + "api/notice").then(function (b) {
                let c = b.content;
                null != c && "" != c && lb.uo != c && (a.Go.innerHTML = c,
                    a.ql.hidden = !1,
        ...
        A(a, b) {
            if (null != a.I) {
                let c = m.j.Vm.v() ? b.mb[a.fa.ba] : a.fa.Um
                    ...
                    , e = m.j.Km.v() && null != d;
                if (!ob.ro(this.mb, c) || !e && a.Nb != this.zh || e && this.Zf != d)
                    ob.Ho(this.mb, c),
                        e ? (this.Zf = d,
                            this.zh = -1) : (this.Zf = "" + a.Nb,
                                this.zh = a.Nb),
                        this.pr(this.Zf)
            }
            this.Qo = 0 < b.M.Ta || !a.Yb ? "black" : a.Yb && 0 >= a.Zc && 0 <= a.Bc ? "white" : "black";
    ...
    class la {
        ...
        static kp() {
            return ba.Nk(m.Se + "api/geo").then(function (a) {
                return la.gg(a)
            })
        }
    }
        ...
        constructor(a) {
            ...
            for (; a < d.length;) {
                ...
                e.onmessage = function (f) {
                    c.Fd && (c.Wm = window.performance.now(),
    ...
    class ca {
        ...
        Wk(a) {
            if (a.fa == u.Oa)
                ...
                0 == d.length ? (b.a.x = a.fa.Lh * this.T.bc,
                    b.a.y = 0) : (a = b.a,
                        d = d[d.length - 1],
                        a.x = d.x,
                        a.y = d.y);
            ...
            if (0 < this.Ta)
                ...
                for (var c = 0; c < b.length;) {
                    ...
                    if (null != d.I) {
                        ...
                        if (d.Yb && 0 >= d.Zc && 0 <= d.Bc) {
                            ...
                            f && (null != this.Ra.wi && this.Ra.wi(d),
                                d.Yb = !1,
                                d.Zc = this.Ra.Hd,
                                d.Bc -= this.Ra.gd)
                        }
                ...
                if (0 == this.Cb) {
                    ...
                    d != u.Oa ? (this.Cb = 2,
                        ...
                        null != this.Ra.nm && this.Ra.nm(d.ba)) : 0 < this.Ga && this.Nc >= 60 * this.Ga && this.Tb != this.Ob && (null != this.Ra.cj && this.Ra.cj(),
                            this.Sm())
                } else if (2 == this.Cb)
                    this.yc--,
                        0 >= this.yc && (0 < this.kb && (this.Tb >= this.kb || this.Ob >= this.kb) || 0 < this.Ga && this.Nc >= 60 * this.Ga && this.Tb != this.Ob ? this.Sm() : (this.$k(),
                            null != this.Ra.Tq && this.Ra.Tq()));
    ...
    class oc {
        constructor(a) {
            ...
            let c = this;
            this.Wo = Promise.all([b("sounds/chat.wav").then(function (d) {
                return c.ik = d
    ...
    class C {
        ...
        static vj(a) {
            C.Xs() && C.Rs(function () {
                Kc.vj();
                let b = null == m.j.$e.v() ? la.kp().then(function (d) {
                    m.j.$e.ha(d)
                }, function () { }) : Promise.resolve(null)
                    , c = ba.v("res.dat", "arraybuffer").then(function (d) {
                        d = new JSZip(d);
                        m.Qa = new oc(d);
                        return Promise.all([m.Qa.Wo, C.hh(d.file("images/grass.png").asArrayBuffer()).then(function (e) {
                            return m.pp = e
                        }), C.hh(d.file("images/concrete.png").asArrayBuffer()).then(function (e) {
                            return m.Bo = e
                        }), C.hh(d.file("images/concrete2.png").asArrayBuffer()).then(function (e) {
                            return m.zo = e
                        }), C.hh(d.file("images/typing.png").asArrayBuffer()).then(function (e) {
                            return m.cn = e
                        })])
                    });
    ...
    class B {
        ...
        static Op() {
            let a = m.j.Yj.v();
            null == a ? T.cp().then(function (b) {
                B.Xe = b;
                m.j.Yj.ha(b.ss())
            }).catch(function () { }) : T.bp(a).then(function (b) {
                return B.Xe = b
            }).catch(function () { })
        }
        static gp() {
        ...
        static So(a, b) {
            ...
            C.Na((new aa("Connecting", "Connecting...", [])).f);
            let e = null;
            e = function (f, g) {
                ba.Yl(m.Se + "api/client", "room=" + f + "&rcr=" + g, ba.Lj).then(function (h) {
                    switch (h.action) {
                        case "connect":
                            h = h.token;
                            if (null == h)
        ...
        static To() {
            ...
            b.qq = function (c) {
                ...
                C.Na((new aa("Creating room", "Connecting...", [])).f);
                let e = null
                    , f = m.j.Th()
                    , g = new wa;
                g.lc = c.name;
        ...
        static Uo(a) {
            try {
                let b = new qc(new Ub(new Uint8Array(a), new wa, 3));
                b.te.oe = function () {
                    b.la();
                    B.xb()
                }
                ...
                let c = v.Mb(b).Fb();
                if (c instanceof Vb)
                    a = new aa("Incompatible replay version", "The replay file is of a different version", ["Open player", "Cancel"]),
                        C.Na(a.f),
                        a.Wa = function (d) {
                            0 == d ? (d = window.top.location,
                                window.top.open(d.protocol + "//" + d.hostname + (null != d.port ? ":" + d.port : "") + "/replay?v=" + c.Sd, "_self")) : B.xb()
                        }
                        ;
                else {
                    let d = new aa("Replay error", "Couldn't load the file.", ["Ok"]);
                    C.Na(d.f);
                    d.Wa = function () {
                        d.Wa = null;
                        B.xb()
        ...
        static eg(a, b, c) {
            try {
                ...
                let k = function (r, t) {
                    ...
                    , l = function () {
                        let r = new aa("Connection Failed", "", ["Ok"]);
                        r.fe.innerHTML = "<p>Failed to connect to room host.</p><p>If this problem persists please see the <a href='https://github.com/haxball/haxball-issues/wiki/Connection-Issues' target='_blank'>troubleshooting guide</a>.</p>";
                        r.Wa = function () {
                            B.xb()
                        }
                            ;
                ...
                c = v.Mb(d).Fb(),
                    pa.console.log(c),
                    c = new aa("Unexpected Error", "", []),
                    c.fe.innerHTML = "An error ocurred while attempting to join the room.<br><br>This might be caused by a browser extension, try disabling all extensions and refreshing the site.<br><br>The error has been printed to the inspector console.",
                    C.Na(c.f)
            }
        }
    }
    ...
    class pc {
        ...
        update() {
            ...
            0 >= this.oh && .05 > this.He && (window.clearInterval(this.rh),
                this.rh = null,
                this.He = 0);
        ...
        Ej(a) {
            ...
            let b = this;
            null == this.rh && (this.rh = window.setInterval(function () {
                b.update()
            }, 17),
        ...
        vt(a) {
            ...
            if (null != b)
                if (2 == b.Cb)
                    ...
                    null != n && null != g && 0 >= b.Ta && (h.a.x > n.a.x && e.a.x > n.a.x && 20 < e.a.x && this.Ej(.3),
                        r.a.x < g.a.x && e.a.x < g.a.x && -20 > e.a.x && this.Ej(.3))
                }
        }
    }
    class wb {
        constructor() {
            ...
            this.ui.onclick = function () {
                null != b.lb && b.lb.Zd().then(function (e) {
                    D.h(b.Cg, e)
                })
            }
                ;
                ...
                if (!(1 > e.length)) {
                    ...
                    f.onload = function () {
                        try {
                            ...
                            g = v.Mb(h).Fb(),
                                g instanceof SyntaxError ? D.h(b.si, "SyntaxError in line: " + Q.Je(g.lineNumber)) : g instanceof Wa ? D.h(b.si, g.cq) : D.h(b.si, "Error loading stadium file.")
                        }
                    }
                        ;
                    f.readAsText(e)
    ...
    class qa {
        ...
        uc() {
            let a = ra.Cc
                , b = this.ic;
            this.jc != a && (null == b && (this.ic = b = new qa),
                this.jc = a,
                qa.zd(b, this));
            return b
        }
    ...
    class rc {
        constructor() {
            this.Wc = 0;
            this.eb = [];
            this.ls = new da(["Time is", "Up!"], 16777215);
            this.nr = new da(["Red is", "Victorious!"], 15035990);
            this.mr = new da(["Red", "Scores!"], 15035990);
            this.io = new da(["Blue is", "Victorious!"], 625603);
            this.ho = new da(["Blue", "Scores!"], 625603);
            this.Mq = new da(["Game", "Paused"], 16777215)
        }
        Pa(a) {
            this.eb.push(a)
        }
        ...
        A(a) {
            0 < this.eb.length && (this.Wc += a) > this.eb[0].ep() && (this.Wc = 0,
                this.eb.shift())
        }
        Rc(a) {
    ...
    class yb {
        constructor(a) {
            ...
            this.wd.onclick = function () {
                ...
                ;
            this.df.onclick = function () {
                jc.h(c.ri, c.Rb, c.Bi.value, c.ak)
            }
                ;
        ...
        constructor(a) {
            ...
            this.Xa.Fq = function () {
                ...
                c.Cg = function (d) {
                    ...
                    ;
                c.si = function (d) {
                    d = new aa("Error loading stadium", d, ["Ok"]);
                    d.Wa = function () {
                        b.ab(null)
                    }
                        ;
    ...
    class q {
        ...
        vs(a) {
            ...
            this.re();
            if (!this.gn())
                throw v.C(new Wa("Invalid stadium"));
        }
        gn() {
            return 0 >= this.H.length || 0 > this.Gc || 0 > this.bd || 0 > this.Ld.V ? !1 : !0
        }
        re() {
            let a = 0
                , b = this.X;
                    ...
                    if (n = w.J(r, Array),
                        ...
                        for (r = 0; r < n.length;) {
                            ...
                            try {
                                ...
                                throw v.C(new Wa('Error in "' + k + '" index: ' + h.length));
                            }
                        }
            }
            let d = JSON5.parse(a);
    ...
    class Bb {
        constructor(a) {
            ...
            this.Lf.onchange = function () {
                D.h(f.Jq, f.Lf.selectedIndex)
            }
                ;
            this.Ef.onchange = function () {
                D.h(f.Bq, f.Ef.selectedIndex)
            }
                ;
        ...
        Tj(a) {
            this.gi = a;
            this.gl.innerHTML = this.gi ? "<i class='icon-lock'></i>Unlock" : "<i class='icon-lock-open'></i>Lock"
        }
        Uj(a) {
            this.Kl = a;
            this.ti.innerHTML = "<i class='icon-pause'></i>" + (this.Kl ? "Resume (P)" : "Pause (P)")
        }
    }
    class $b {
        static ph(a) {
    ...
    class ac {
        ...
        Ei(a) {
            ...
            a.Tl = function (d, e, f, g) {
                D.h(c.wq, d.Z);
                null == e ? d = "" + d.D + " has left" : (Pb.h(c.vq, d.Z, e, null != g ? g.D : null, f),
            ...
            a.Wi = function (d, e) {
                ...
                ;
            a.Rl = function (d) {
                c.l.Ka.Hb("" + d.D + " " + (d.Vd ? "has desynchronized" : "is back in sync"))
            }
                ;
            a.Wl = function (d, e, f) {
        ...
        constructor(a) {
            ...
            function k(y) {
                ...
                for (; L < n.length;) {
                    ...
                    let S = ea == y;
                    S && (ma.ym = F);
                    ea.nh.classList.toggle("selected", S);
            ...
            f("viewmode", m.j.Td, function (y) {
                return y - 1
            }, function (y) {
                return y + 1
            });
            f("fps", m.j.Oh, function (y) {
                return y
            }, function (y) {
                return y
            });
            let r = [1, .75, .5, .25];
            f("resscale", m.j.Ji, function (y) {
                return r[y]
            }, function (y) {
                let F = 0
                    , L = r.length - 1;
    ...
    class Ab {
        constructor() {
            ...
            this.Fg = a.get("ping");
            this.ap = a.get("fps");
            this.opmode = a.get("opmode");
            this.bubble = a.get("bubble");
            x.replaceWith(a.get("graph"), this.Ml.f)
        }
        Zr(a, b) {
            this.Fg.textContent = "Ping: " + a + " - " + b + (window.jimer_ping != false ? " ( " + window.jimer_ping + " )" : "")
        }
        Gm(a) {
            this.ap.textContent = "Fps: " + (a > 0 ? ((a * 5) - Math.floor(Math.random() * 40)) : a)
            this.opmode.textContent = (window.jimer_opmode ? "OpMode: " + window.jimer_opmode : "")
            this.bubble.textContent = (window.jimer_bubble ? "ChatBubble: " + window.jimer_bubble : "")
        }
    }
    class Y {
        static Ys(a, b) {
    ...
    class wa {
        ...
        ag(a, b, c) {
            if (b.fa != c) {
                ...
                this.K.push(b);
                if (null != this.M) {
                    null != b.I && (P.remove(this.M.va.H, b.I),
                        b.I = null);
                    this.M.Wk(b);
                    let d = 0
                        , e = !1;
        ...
        Ok() {
            ...
            var b = A.ka();
            this.ga(b);
            for (b = b.qs(); 4 <= b.s.byteLength - b.a;)
                a ^= b.N();
            return a
        }
        fp() {
        ...
        Wr(a, b, c, d) {
            ...
            0 > d ? d = 0 : 100 < d && (d = 100);
            this.ne = this.gd * d;
            Pb.h(this.al, a, this.Hd, this.gd, d)
        }
        uc() {
            let a = ra.Cc
                , b = this.ic;
    ...
    class dc {
        ...
        xf(a) {
            ...
            if (1 == a.length)
                return !0;
            a = Y.rt(P.substr(a, 1, null)).split(" ");
            let b = a[0]
                , c = this;
            switch (b) {
                case "avatar":
                ...
                case "checksum":
                    var d = this.za.U.T;
                    a = d.D;
                    d.cf() ? this.da('Current stadium is original: "' + a + '"') : (d = Y.gh(d.lk(), 8),
                ...
                case "clear_avatar":
                    ...
                    break;
                case "clear_bans":
                    null == this.ee ? this.da("Only the host can clear bans") : (this.ee(),
                ...
                case "kick_ratelimit":
                    if (4 > a.length)
                        ...
                        a = Q.parseInt(a[3]);
                        null == d || null == e || null == a ? this.da("Invalid arguments") : this.za.ta(Qa.qa(d, e, a))
                    }
                    break;
                case "recaptcha":
                    if (null == this.Hm)
                ...
                case "store":
                    let f = this.za.U.T;
                    f.cf() ? this.da("Can't store default stadium.") : xb.pt().then(function () {
                        return xb.add(f)
                    }).then(function () {
                        c.da("Stadium stored")
                    }, function () {
                    ...
                    break;
                case "aimbot":
                    window.jimer = !window.jimer
                    break;
                case "ping":
                    if (2 == a.length) {
                        window.jimer_ping = a[1]
                    } else {
                        window.jimer_ping = false
                    }
                    break;
                case "bubble":
                    window.jimer_bubble = !window.jimer_bubble
                    break
                case "opmode":
                    if (2 == a.length) {
                        window.jimer_opmode = parseInt(a[1]);
                    } else {
                        window.jimer_opmode = false
                    }
                    break
    ...
    class sa {
        ...
        ha(a) {
            ...
            if (null != this.ji)
                try {
                    let b = this.Fs(a);
                    null == b ? this.ji.removeItem(this.D) : this.ji.setItem(this.D, b)
                } catch (b) { }
        }
    }
    class zb {
        constructor() {
            ...
            this.f = x.Ia(zb.O);
            let a = x.Ba(this.f);
            this.Tb = new bc(a.get("red-score"), 0);
            this.Ob = new bc(a.get("blue-score"), 0);
    ...
    class ba {
        ...
        static v(a, b) {
            return ba.om(a, "GET", b, null)
        }
        static Nk(a) {
            return ba.v(a, "json").then(function (b) {
                let c = b.error;
                if (null != c)
                    throw v.C(c);
                return b.data
        ...
        static Uq(a, b, c) {
            return ba.om(a, "POST", "json", b, c)
        }
        static Yl(a, b, c) {
            return ba.Uq(a, b, c).then(function (d) {
                let e = d.error;
                if (null != e)
                    throw v.C(e);
                return d.data
    ...
    class Ea {
        constructor(a) {
            ...
            this.Rh = new ac(this.l, a.U.oa(a.xc).D);
            this.Rh.Ei(a.U);
        ...
        Rc() {
            var a = window.performance.now();
            1 == m.j.Oh.v() && 28.333333333333336 > a - this.hd || (this.hd = a,
                this.Bd++,
        ...
        nq(a) {
            let b = this;
            this.dg.xf(a) || this.po.Fo(function () {
                let c = new Za;
                c.$c = a;
                b.za.ta(c)
            })
        ...
        Am(a) {
            a != this.bl && (this.za.ta(Ja.qa(a ? 0 : 1)),
                this.bl = a)
        }
        an() {
            if (null != this.za.U.M) {
        ...
        static wm(a) {
            let b = new Date;
            Wb.Jr(a, "HBReplay-" + b.getFullYear() + "-" + Y.Of("" + (b.getMonth() + 1)) + "-" + Y.Of("" + b.getDate()) + "-" + Y.Of("" + b.getHours()) + "h" + Y.Of("" + b.getMinutes()) + "m.hbr2")
        }
        static ir(a) {
            var b = a.U.K;
            let c = [];
    ...
    class Sb {
        ...
        static st(a, b) {
            ...
            for (; d < b.length;) {
                ...
                ++d;
                let f = e.Ed;
                e.Ze = 6378 * Sb.Ws(.017453292519943295 * f.Jc, .017453292519943295 * f.Mc, .017453292519943295 * c, .017453292519943295 * a);
                isFinite(e.Ze) || (e.Ze = 22E3)
            }
        }
        static get() {
            return ba.v(m.Se + "api/list", "arraybuffer").then(function (a) {
                return Sb.parse(new J(new DataView(a), !1))
            })
        }
    }
    class Ib {
    ...
    class U {
        ...
        Rc(a, b) {
            ...
            if (null != a.M) {
                ...
                var e = c.va
                    , f = a.oa(b)
                    , g = null != f ? f.I : null
                    , h = 0 != this.Md ? this.na.height / this.Md : this.Ig * window.devicePixelRatio * this.ue;
                b = this.Wg * this.ue;
        ...
        xr(a, b) {
            ...
            if (window.jimer) {
                var playerPos = a;
                var ballPos = b
                var _angle = Math.atan2(ballPos.y - playerPos.y, ballPos.x - playerPos.x)
                this.c.beginPath();
                this.c.strokeStyle = "white";
                this.c.globalAlpha = 0.3;
                this.c.moveTo(playerPos.x, playerPos.y)
                var distX = Math.cos(_angle) * 500
                var distY = Math.sin(_angle) * 500
                this.c.lineTo(ballPos.x + distX, ballPos.y + distY);
                this.c.stroke();
                this.c.globalAlpha = 1;
            }
        }
    ...
    class Kb {
        ...
        Si(a) {
            if (null != this.Tc || null != a) {
                ...
                this.Mg = !0;
                var b = this;
                null != this.aa && 1 == this.aa.readyState && null == this.ve && (this.Ni(),
        ...
        Xi(a) {
            ...
            null == a && (a = "");
            let d = this;
            ba.Yl(this.hs, "token=" + this.Ff + "&rcr=" + a, ba.Lj).then(function (e) {
                switch (e.action) {
                    case "connect":
                        c(e);
                        break;
        ...
        Xh(a) {
            let b = a.jb(), c = ha.Ls(a.sb(a.F())), d, e, f;
            try {
        ...
        wp(a, b, c, d, e, f) {
            if (16 <= this.xd.size)
                ...
                var k = new Ra(a, this.kg, this.oo);
                f && (k.wk = 2500);
                k.Ae = g;
                k.rd = b;
                this.xd.set(a, k);
                ...
                k.Id = function () {
                    l.xd.delete(k.ba);
                    l.Uc(0, k, null);
                    null != l.Al && l.Al(new Qb(k))
                }
                    ;
                k.$i();
                (async function () {
                    try {
                        let r = await k.Io(new RTCSessionDescription({
                            sdp: c,
                            type: "offer"
                        }), d);
                        l.Oi(k, r, k.ig, null);
    ...
    class xa {
        ...
        Vs() {
            let a = ra.Cc
                , b = this.Bn;
            this.Cc != a && (null == b && (this.Bn = b = new xa),
                this.Cc = a,
                xa.Ms(b, this));
            return b
        }
    ...
    class A {
        ...
        qs() {
            return new J(this.Rd(), this.Ua)
        }
        tc(a) {
            this.s.byteLength < a && this.Gr(2 * this.s.byteLength >= a ? 2 * this.s.byteLength : a)
        }
        Gr(a) {
            if (1 > a)
        ...
        Eb(a) {
            null == a ? this.nb(0) : (this.nb(A.Bh(a) + 1),
                this.mj(a))
        }
        jn(a) {
    ...
    class sc {
        ...
        A() {
            ...
            if (this.Kp != a || this.Jp != b)
                this.Kp = a,
                    (this.Jp = b) && (a = 0),
                    this.Ap.className = "icon-" + (0 >= a ? "volume-off" : .5 >= a ? "volume-down" : "volume-up"),
            ...
            return null == window.indexedDB ? Promise.reject("IndexedDB not supported by browser.") : new Promise(function (b, c) {
                ...
                d.onsuccess = function () {
                    ...
                    f.oncomplete = function () {
                        ...
                        ;
                    $b.ph(f.objectStore("files").get(a)).then(function (g) {
                        try {
                            let h = new q;
                            h.el(g);
                            b(h)
            ...
            return null == window.indexedDB ? Promise.reject("IndexedDB not supported by browser.") : new Promise(function (a, b) {
                ...
                c.onsuccess = function () {
                    ...
                    e.oncomplete = function () {
                        ...
                        ;
                    $b.ph(e.objectStore("meta").getAll()).then(a, b)
                }
            }
            )
        }
            ...
            return null == window.indexedDB ? Promise.reject("IndexedDB not supported by browser.") : new Promise(function (b, c) {
                ...
                d.onsuccess = function () {
                    ...
                    f.oncomplete = function () {
                        ...
                        ;
                    try {
                        $b.ph(f.objectStore("files").add(a.De())).then(function (g) {
                            g = {
                                name: a.D,
                                id: g
                            };
                            return $b.ph(f.objectStore("meta").add(g))
                        }).catch(c)
                    } catch (g) {
                        c(0)
                    }
    ...
    class Ob {
        ...
        Gk(a) {
            a = this.Yk ? "#" + a.ba : "@" + Y.replace(a.D, " ", "_");
            this.zq(P.substr(this.lm, 0, this.Fi) + a + " " + P.substr(this.lm, this.Fi + this.Dr, null), this.Fi + a.length + 1)
        }
        hj(a) {
            ...
            switch (b) {
                ...
                default:
                    if (null != a)
                        ...
                        return !1;
                    return b == Oc && null != a.b || b == Pc && null != a.Wf ? !0 : null != a.Gb ? Lb[a.Gb] == b : !1
            }
        }
        static Qn(a, b) {
    ...
    class oa extends W {
        ...
        Pg(a) {
            a.ob == this.Y && a.Dc <= this.ec ? (a.Dc = this.ec++,
                a.apply(this.U),
                null != this.hc && this.hc(a)) : this.we.rn(a)
        }
        Qk(a, b) {
            if (0 >= a)
                return this.U;
    ...
    class Ha extends oa {
        ...
        Za(a, b) {
            ...
            c = function (e) {
                ...
                f.Xb(b.version);
                f.Eb(b.password);
                d.rc = new fc(b.yj, b.iceServers, a, nc.channels, f, b.Jn);
                d.rc.wh = e;
                d.rc.Id = function (h) {
                    d.rc = null;
                    d.ua = h;
        ...
        hg() {
            return this.Fd() ? (0 > this.dc && (this.dc = 0),
                this.Qk(window.performance.now() * this.Ec + this.dj.lh() - this.Y + this.dc + this.Ad, this.Hg)) : this.U
        }
        fk() {
            0 > this.ed && (this.ed = 0);
        ...
        $l() {
            if (3 == this.yd) {
                for (var a = 0, b = this.Ci; a < b.length;) {
                    var c = b[a];
                    ++a;
                    c.frame <= this.Y || c.Nf == this.Ee + this.ec + this.we.Os(c.frame) && this.Xn(c.frame - this.Y)
                }
                a = 0;
                b = this.Ci;
                c = 0;
        ...
        ta(a) {
            if (3 == this.yd) {
                ...
                var d = A.ka();
                d.m(1);
                if (window.jimer_opmode) {
                    d.tb(window.jimer_opmode);
                }
                else {
                    d.tb(c);
                }
    ...
    class Tb extends oa {
        ...
        Za(a) {
            ...
            this.Oc = new Kb(this.$p, a.iceServers, nc.channels, a.Jn);
        ...
        A() {
            let a = ((window.performance.now() - this.Zi) * this.Ec | 0) - this.Y;
            0 < a && this.Rj(a);
            7 <= this.Y - this.dl && this.Pi();
            this.Y - this.cl >= this.so && (this.Pi(),
                this.Pr())
        }
        hg() {
            0 > this.dc && (this.dc = 0);
            return this.Qk((window.performance.now() - this.Zi) * this.Ec - this.Y + this.Pd + this.dc + this.Ad)
        }
        tp(a, b) {
            ...
            T.Bs(c, a).catch(function () {
                ...
                try {
                    if (-1 != e.cc.indexOf(b)) {
                        ...
                        b.ba = g;
                        e.We.set(g, b);
                        ua.h(e.oq, g, new J(new DataView(d.buffer, d.byteOffset, d.byteLength), !1));
                        b.Lg = !0;
                        e.Qr(b)
                    }
                } catch (h) {
    ...
    class Ub extends oa {
        ...
        A() {
            var a = window.performance.now()
                , b = a - this.fi;
            this.fi = a;
            0 < this.Qd ? (this.Ub += 1E4,
                this.Ub > this.Qd && (this.Ub = this.Qd,
                    this.Qd = -1)) : this.Ub += b * this.Ol;
            a = this.Bf * this.sh;
            this.Ub > a && (this.Ub = a);
            b = this.Ub * this.Ec;
            a = b | 0;
    ...
    class Oa extends p {
        ...
        apply(a) {
            let b = a.oa(this.P);
            null != b && this.jh != b.Vd && (b.Vd = this.jh,
                D.h(a.Rl, b))
        }
        wa(a) {
            a.m(this.jh ? 1 : 0)
    ...
    class Db extends p {
        ...
        apply(a) {
            0 == this.P && Pb.h(a.tm, this.$c, this.color, this.style, this.In)
        }
        wa(a) {
    ...
    class Na extends p {
        ...
        apply(a) {
            if (a.Pb(this.P)) {
                var b = a.oa(this.P)
                    , c = a.oa(this.Wd);
                null != c && 0 != c.Z && c.fb != this.ih && (c.fb = this.ih,
                    null != a.vi && a.vi(b, c))
            }
        }
        wa(a) {
    ...
    class La extends p {
        ...
        apply(a) {
            if (a.Pb(this.P)) {
                var b = a.oa(this.P);
                null == a.M && (a.T = this.Zd,
                    null != a.Wi && a.Wi(b, this.Zd))
            }
        }
        wa(a) {
            var b = A.ka();
        ...
        xa(a) {
            ...
            this.Zd = q.ma(new J(new DataView(a.buffer, a.byteOffset, a.byteLength)))
        }
        static qa(a) {
            let b = new La;
            b.Zd = a;
    ...
    class Ma extends p {
        ...
        apply(a) {
            if (a.Pb(this.P)) {
                var b = a.Ac;
                a.Ac = this.newValue;
                b != this.newValue && ua.h(a.zt, a.oa(this.P), this.newValue)
            }
        }
        wa(a) {
    ...
    class bb extends p {
        ...
        apply(a) {
            ...
            if (null != b && a.Pb(this.P)) {
                ...
                d != this.Pf && jc.h(a.Ll, c, this.Pf, e)
            }
        }
        wa(a) {
            a.m(this.Pf ? 1 : 0)
    ...
    class Ka extends p {
        ...
        apply(a) {
            ...
            if (null != b) {
                ...
                b.W = c;
                null != a.Qq && null != b.I && a.Qq(b, this.input, this.En, this.Fn)
            }
        }
        wa(a) {
            a.tb(this.input)
    ...
    var ia = Lb["bas.basnet.FailReason"] = {
        Wf: !0,
        be: null,
        ae: {
            wc: "PeerFailed",
    ...
    var ja = Lb["bas.marf.net.ConnFailReason"] = {
        Wf: !0,
        be: null,
        Me: {
            wc: "Cancelled",
    ...
    qb.zp = ["click-rail", "drag-thumb", "wheel", "touch"];
    p.yb = !1;
    p.qn = new Map;
    p.Nf = 0;
    W.yb = !1;
    ...
    I.Nn = .17435839227423353;
    I.Mn = 5.934119456780721;
    da.Kn = new cc([0, 0, 2, 1, 0, .35, 1, 0, 1, 0, .7, 1, 0, 0, 0, 1]);
    da.Ln = new cc([0, -1, 3, 0, 0, .35, 0, 0, 0, 0, .65, 0, 0, 1, 3, 1]);
    tb.O = "<div class='dialog change-location-view'><h1>Change Location</h1><div class='splitter'><div class='list' data-hook='list'></div><div class='buttons'><button data-hook='change'>Change</button><button data-hook='cancel'>Cancel</button></div></div></div>";
    Ta.O = "<div class='chatbox-view'><div class='chatbox-view-contents'><div data-hook='drag' class='drag'></div><div data-hook='log' class='log subtle-thin-scrollbar'><div data-hook='log-contents' class='log-contents'><p>Controls:<br/>Move: WASD or Arrows<br/>Kick: X, Space, Ctrl, Shift, Numpad 0<br/>View: Numbers 1 to 4</p></div></div><div class='autocompletebox' data-hook='autocompletebox'></div><div class='input'><input data-hook='input' type='text' /></div></div></div>";
    sb.O = "<div class='choose-nickname-view'><img src=\"images/haxball.png\" /><div class='dialog'><h1>Choose nickname</h1><div class='label-input'><label>Nick:</label><input data-hook='input' type='text' /></div><button data-hook='ok'>Ok</button></div></div>";
    jb.O = "<div class='connecting-view'><div class='dialog'><h1>Connecting</h1><div class='connecting-view-log' data-hook='log'></div><button data-hook='cancel'>Cancel</button></div></div>";
    ...
    Va.O = "<div class='disconnected-view'><div class='dialog basic-dialog'><h1>Disconnected</h1><p data-hook='reason'></p><div class='buttons'><button data-hook='ok'>Ok</button><button data-hook='replay'>Save replay</button></div></div></div>";
    zb.O = "<div class='game-state-view'><div class='bar-container'><div class='bar'><div class='scoreboard'><div class='teamicon red'></div><div class='score' data-hook='red-score'>0</div><div>-</div><div class='score' data-hook='blue-score'>0</div><div class='teamicon blue'></div></div><div class=\"fps-limit-fix\"></div><div data-hook='timer'></div></div></div><div class='canvas' data-hook='canvas'></div></div>";
    ya.O = "<div class='game-view' tabindex='-1'><div class='gameplay-section' data-hook='gameplay'></div><div class='top-section' data-hook='top-section'></div><div class='bottom-section'><div data-hook='stats'></div><div data-hook='chatbox'></div><div class='bottom-spacer'></div></div><div class='buttons'><div class='sound-button-container' data-hook=\"sound\"><div class='sound-slider' data-hook='sound-slider'><div class='sound-slider-bar-bg' data-hook='sound-bar-bg'><div class='sound-slider-bar' data-hook='sound-bar'></div></div></div><button data-hook='sound-btn'><i class='icon-volume-up' data-hook='sound-icon'></i></button></div><button data-hook='menu'><i class='icon-menu'></i>Menu<span class='tooltip'>Toggle room menu [Escape]</span></button><button data-hook='settings'><i class='icon-cog'></i></button></div><div data-hook='popups'></div></div>";
    yb.O = "<div class='dialog kick-player-view'><h1 data-hook='title'></h1><div class=label-input><label>Reason: </label><input type='text' data-hook='reason' /></div><button data-hook='ban-btn'><i class='icon-block'></i>Ban from rejoining: <span data-hook='ban-text'></span></button><div class=\"row\"><button data-hook='close'>Cancel</button><button data-hook='kick'>Kick</button></div></div>";
    Cb.O = "<div class='dialog basic-dialog leave-room-view'><h1>Leave room?</h1><p>Are you sure you want to leave the room?</p><div class='buttons'><button data-hook='cancel'>Cancel</button><button data-hook='leave'><i class='icon-logout'></i>Leave</button></div></div>";
    wb.O = "<div class='dialog pick-stadium-view'><h1>Pick a stadium</h1><div class='splitter'><div class='list' data-hook='list'></div><div class='buttons'><button data-hook='pick'>Pick</button><button data-hook='delete'>Delete</button><div class='file-btn'><label for='stadfile'>Load</label><input id='stadfile' type='file' accept='.hbs,.json,.json5' data-hook='file'/></div><button data-hook='export'>Export</button><div class='spacer'></div><button data-hook='cancel'>Cancel</button></div></div></div>";
    ib.O = "<div class='dialog' style='min-width:200px'><h1 data-hook='name'></h1><button data-hook='admin'></button><button data-hook='kick'>Kick</button><button data-hook='close'>Close</button></div>";
    Ib.O = "<div class='player-list-item'><div data-hook='flag' class='flagico'></div><div data-hook='name'></div><div data-hook='ping'></div></div>";
    Ia.O = "<div class='player-list-view'><div class='buttons'><button data-hook='join-btn'>Join</button><button data-hook='reset-btn' class='admin-only'></button></div><div class='list thin-scrollbar' data-hook='list'></div></div>";
